...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            'script_url' => $this->get_full_url().'/uploads/articles/ar_'.$_POST['last_article_id'],
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/uploads/articles/ar_'.$_POST['last_article_id'].'/',
            'upload_url' => $this->get_full_url().'/uploads/articles/ar_'.$_POST['last_article_id'].'/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
    ...
    protected function set_additional_file_properties($file) {
        $file->deleteUrl = site_url().'/fileupload/deleteFile/'.$_POST['last_article_id'].'/'.rawurlencode($file->name);
