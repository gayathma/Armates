                                            ...
                                            <table class="contents" style="border-collapse: collapse;border-spacing: 0;table-layout: fixed;width: 100%">
                                                <tbody><tr>
                                                        <td class="padded" style="padding: 0;vertical-align: top;padding-left: 32px;padding-right: 32px;word-break: break-word;word-wrap: break-word">
                                                            ...
                                                            <h3 style="Margin-top: 0;color: #555;font-weight: normal;font-size: 18px;line-height: 26px;Margin-bottom: 16px;font-family: Georgia,serif">Hi Admin,</h3><p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px"><?php echo $comments;?></p><p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px">Thanks.</p><p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px"><?php echo $name;?></p><blockquote style="Margin-top: 0;Margin-right: 0;Margin-bottom: 0;padding-right: 0;font-style: italic;font-size: 14px;border-left: 2px solid #e9e9e9;Margin-left: 0;padding-left: 16px"><p style="Margin-top: 0;color: 
                                                                                                                                                                                                        #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 24px">view more details on <a style="text-decoration: underline;transition: all .2s;color: #41637e" data-emb-href-display="armates.com/backend.php/comments/manage_comments" href="http://armates.com/backend.php/comments/manage_comments">ARMATES</a></p></blockquote><p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 24px">&nbsp;</p>
