...
<!--[if gt IE 8]><!--> <html class="no-js" dir="ltr" lang="en-US"> <!--<![endif]-->
    ...
    <head>
        ...
        <meta name="Description" content="Hempstead â€“ Responsive Retina-Ready HTML5 Portfolio" />
        <link href="<?php echo base_url(); ?>application_resources/css/reset.css" rel="stylesheet" type="text/css" media="screen" />
        <link href="<?php echo base_url(); ?>application_resources/css/contact.css" rel="stylesheet" type="text/css" media="screen" />
        <link href="<?php echo base_url(); ?>application_resources/css/styles.css" rel="stylesheet" type="text/css" media="screen" />
        <link href="<?php echo base_url(); ?>application_resources/css/flexslider.css" rel="stylesheet" type="text/css" media="screen" />
        <link href="<?php echo base_url(); ?>application_resources/css/animate.css" rel="stylesheet" type="text/css" media="screen" />
        <link href="<?php echo base_url(); ?>application_resources/css/jquery.fancybox.css" rel="stylesheet" type="text/css" media="screen" />
        <!--[if gt IE 8]><!--><link href="<?php echo base_url(); ?>application_resources/css/retina-responsive.css" rel="stylesheet" type="text/css" media="screen" /><!--<![endif]-->
        <!--[if !IE]> <link href="<?php echo base_url(); ?>application_resources/css/retina-responsive.css" rel="stylesheet" type="text/css" media="screen" /> <![endif]-->
        <link href="<?php echo base_url(); ?>application_resources/css/print.css" rel="stylesheet" type="text/css" media="print" />
    ...
    <body>
                        ...
                        <div id="container" class="clearfix">
                            <div class="element  clearfix col2-3 services auto">
                                ...
                                <div class="col2-3 auto white-bottom">
                                    ...
                                    <h3>We are absolutely passionate about simple yet sophisticated user experience and designs that we, and our clients, are very proud of.</h3>
                                </div>
                            </div>
                            <div class="element  clearfix col2-3 blog auto">
                                ...
                                <div class="col2-3 auto white-bottom">
                                    ...
                                    <h3> We are regarded as industry leaders in stunning website solutions, focused on delivering unsurpassed user experiences. Stay up to date with our blog.</h3>
                                </div>
                            </div>
                            ...
                            <div class="element  clearfix col2-3 home about grey grid-fit" style="padding:0">

                                <a href="ar.php" title="">
                                    <figure class="images"> 
                                        <div class="sliphoveritem" style="border-radius:0px;width:300px;height:280px;text-align:center;overflow:hidden;position:absolute;top:0px;left:0px;">
                                ...
                                <!-- <p class="small">Hello from Armates,</p>
                                   <h2>
                                               You are just landed to the world of creativity, interactivity and both.
                       Every single thing we do here makes your clients happy.Get involved with us. 
                                    </h2> -->
                            </div>
                            ...
                            <div class="element  clearfix col1-3 services grey auto">
                                ...
                                <p>Lorem ipsum dolor sit amet, consetetur sed diam nonumy eirmod tempor invidunt.</p>
                                <h5>The Process</h5>
                                <ol>
                                    <li>Strategy:<br />
                                        Adipiscing et, fringilla eget justo.</li>
                                    <li>Design:<br />
                                        Vestibulum id ligula felis.</li>
                                    <li>Communication:<br />
                            ...
                            <div class="element  clearfix col1-3 services grey auto">
                                ...
                                <ul class="unordered-list">
                                    <li>A supercool hipster collection</li>
                                    <li>Came across the table</li>
                                    <li>This is just dummy text in an unordered list</li>
                                </ul>
                            </div>
                            <div class="element  clearfix col1-3 portfolio photography home"> <a href="project.html" title="">
                            ...
                            <div class="element  clearfix col1-3 about grey"> <a href="http://www.awwwards.com/" data-title="" target="_blank" class="whole-tile">
                                    ...
                                    <h3>Best Website Award May 2014</h3>
                                    <div class="bottom">
                                        <div class="icons winner"></div>
                                        <p class="alignleft">Read More</p>
                                        <span class="arrow">→</span></div>
                                </a> </div>
                            <div class="element  clearfix col1-3 portfolio grey"> <a href="http://graphicriver.net/user/GrafAS/portfolio?ref=weibergmedia" data-title="" target="_blank" class="whole-tile">
                                    <p class="small">Graphicriver</p>
                                    <h3>Want to purchase these mockups?</h3>
                                    <div class="bottom">
                            ...
                            <div class="element  clearfix col1-3 contact grey"> <a href="http://maps.google.com/" target="_blank" class="whole-tile">
                            ...
                            <div class="element  clearfix col1-3 pricing auto">
                                <figure class="price-table">
                                    ...
                                    <a href="#" class="button">Sign Up</a> </figure>
                            </div>
                            <div class="element  clearfix col1-3 pricing auto">
                                <figure class="price-table">
                                    <div class="heading">
                            ...
                            <div class="element  clearfix col1-3 blog grey"><a href="post.html" title="" class="whole-tile">
                                    <p class="small">Nov 11, 2014</p>
                            ...
                            <div class="element  clearfix col1-3 blog auto"><a href="post.html" title="">
                                    ...
                                    <div class="col1-3 white-bottom">
                                        ...
                                        <h3>Featured Post with an Image</h3>
                                        <p>Our collection of modern hipster photographic images. See also our portfolio on Behance. </p>
                                        <div class="bottom"> <span class="arrow">→</span></div>
                                    </div>
                                </a> </div>
                            <div class="element  clearfix col1-3 blog grey"><a href="post.html" title="" class="whole-tile">
                                    <p class="small">Aug 18, 2014</p>
                                    <h3>"Post with an Awesome Quote"</h3>
                                    <p>Our collection of modern hipster photographic images. See also our portfolio on Behance. </p>
                                    <div class="bottom"> <span class="arrow">→</span></div>
                                </a> </div>
                            <div class="element  clearfix col1-3 blog grey"><a href="post.html" title="" class="whole-tile">
                                    <p class="small">July 7, 2014</p>
                                    <h3>Ok, One More</h3>
                                    <p>Our collection of modern hipster photographic images. See also our portfolio on Behance. </p>
                                    <div class="bottom"> <span class="arrow">→</span></div>
                                </a> </div>
                            ...
                            <div class="element clearfix col1-3 contact auto">
                                <div class="elem-content">
                                    ...
                                    <form class="form-part" method="post" action="http://ppp-templates.de/hs/contact.php" name="contactform" id="contactform" autocomplete="off">
        ...
        <script src="<?php echo base_url(); ?>application_resources/js/jquery.isotope2.min.js" type="text/javascript"></script>
        <script src="<?php echo base_url(); ?>application_resources/js/jquery.ba-bbq.min.js" type="text/javascript"></script>
        <script src="<?php echo base_url(); ?>application_resources/js/jquery.isotope.load.js" type="text/javascript"></script>
        <script src="<?php echo base_url(); ?>application_resources/js/SmoothScroll.js" type="text/javascript"></script>
        <script src="<?php echo base_url(); ?>application_resources/js/main.js" type="text/javascript"></script>
        <script src="<?php echo base_url(); ?>application_resources/js/jquery.form.js" type="text/javascript"></script>
        <script src="<?php echo base_url(); ?>application_resources/js/input.fields.js" type="text/javascript"></script>
